...
public class AuthService : IAuthService
{
    ...
    // It takes LoginRequest as type of argument because login
    // and register take the same arguments
    public async Task<Result<string>> Register(LoginRequest registerRequest)
    {
        // We don't have to check if UserName is null here as it is done in controller
        var exists =
